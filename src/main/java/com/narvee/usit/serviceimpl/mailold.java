...
/*
@Service
public class mailold implements IEmailBackupService {
	...
	public void saveBackup(String host, String port, String userName, String password) {
		...
		String from_mail;
		String company_mail;
		String attachment_mail;
		String category_mail;
		
		List<Email> saveem = new ArrayList<>();
	...
	public void saveMail(String subject,String body,String to,String cc,String from_mail,String company,String attachment,String category) {
