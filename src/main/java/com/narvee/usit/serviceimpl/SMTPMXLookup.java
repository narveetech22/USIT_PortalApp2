   ...
   public static boolean isAddressValid( String address ) {
     ...
     for ( int mx = 0 ; mx < mxList.size() ; mx++ ) {
         ...
         try {
             ...
             say( wtr, "MAIL FROM: <arun@narveetech.com>" );
             res = hear( rdr );
...
*/
   public static void main( String args[] ) {
	   ...
	   String s = "abycxfoobaryblablah";
	 //  srishath123.rao@gmail.com
     ...
     String testData[] = {
         "qfqf@gmail.com.com",
         "erehjbejrhv@gmail.com",
         "kiranjava010@gmail.com", // Invalid domain name
