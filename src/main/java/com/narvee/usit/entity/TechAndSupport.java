...
public class TechAndSupport {
	...
	public TechAndSupport(Long id, String name,String technology, int experience, String skills, String email, long mobile, String status) {
		this.id = id;
		this.name = name;
