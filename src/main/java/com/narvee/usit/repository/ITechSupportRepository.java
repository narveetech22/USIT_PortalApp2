...
public interface ITechSupportRepository extends JpaRepository<TechAndSupport, Serializable>{
	...
	//private TechAndSupport(Long id, String name, int experience, String skills, String email, long mobile, int status) {
	
	//Long id, String name, int experience, String skills, String email, long mobile, String status
	//@Query("SELECT new com.narvee.usit.entity.TechAndSupport(t.id, t.name, t.experience, t.skills, t.email, t.mobile, t.status ) from  TechAndSupport t")
