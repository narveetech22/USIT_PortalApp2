...
//		@RequestParam("password") String password
		...
		try {
			...
			return new ResponseEntity<>(new RestAPIResponse("failure", "User Account is InValid", "HO"), HttpStatus.OK);
	...
	public ResponseEntity<RestAPIResponse> forPassdGetResetLink(@PathVariable String email
	...
	public ResponseEntity<RestAPIResponse> forPassdGetResetLink2(@PathVariable String email
			) throws MessagingException {
        System.out.println("email "+email);
...
//        }
	...
	public ResponseEntity<RestAPIResponse> resetPass(@RequestParam("newpassword") String newpassword,
			@RequestParam("email") String email,@RequestParam("confirmpassword") String confirmpassword) throws MessagingException {
